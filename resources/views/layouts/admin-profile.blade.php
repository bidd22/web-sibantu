<div class="flex items-center justify-between w-full">
    ...
    <form method="POST" action="{{ route('logout') }}" class="inline-flex shrink-0">
        @csrf
        <button type="submit" class="flex items-center gap-1.5 px-3 py-2 text-xs font-semibold text-slate-500 hover:text-rose-600 hover:bg-rose-50 rounded-xl transition duration-150" title="Keluar dari akun">
